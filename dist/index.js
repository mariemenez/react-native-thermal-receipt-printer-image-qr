...
var USBPrinter = {
    ...
    printText: function (text, opts) {
        if (opts === void 0) { opts = {}; }
        return new Promise(function (resolve, reject) {
            RNUSBPrinter.printRawData(textTo64Buffer(text, opts), function (printer) {return resolve(printer); }, function (error) { return reject(error); })
        });
    },
    printBill: function (text, opts) {
        if (opts === void 0) { opts = {}; }
        return new Promise(function (resolve, reject) {
            RNUSBPrinter.printRawData(billTo64Buffer(text, opts), function (printer) {return resolve(printer); }, function (error) { return reject(error); })
    ...
    printRaw: function (text) {
        if (Platform.OS === "ios") {
            ...
            RNUSBPrinter.printRawData(text, function (printer) {return resolve(printer); }, function (error) { return reject(error); });
        }
    },
    /**
     * `columnWidth`
